      ...
      <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
          <div>
            ...
            <p className="text-sm mt-12 text-white">Don't have an account 
            <span
          ...
          <form className="max-w-md md:ml-auto w-full">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="text-sm">
                  <a href="" className="text-[#6a51f6]  font-semibold">
            ...
            <div class="!mt-8">
              <button onClick={handleSubmit} type="button" class="w-full shadow-xl py-4 px-4 text-sm font-semibold rounded-xl text-white bg-[#6a51f6] hover:bg-[#584c9f] focus:outline-none">
              Login Now
              </button>
            </div>
